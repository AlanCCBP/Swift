...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let parseConfiguration = ParseClientConfiguration(block: { (ParseMutableClientConfiguration) -> Void in
            ParseMutableClientConfiguration.applicationId = "d5555848065291d20a170a22c74b02f99a0afaca"
            ParseMutableClientConfiguration.clientKey = "7afcb426fddf55b46ad963a0d1aae42bcc217738"
            ParseMutableClientConfiguration.server = "http://ec2-18-221-88-250.us-east-2.compute.amazonaws.com/parse"
        })
